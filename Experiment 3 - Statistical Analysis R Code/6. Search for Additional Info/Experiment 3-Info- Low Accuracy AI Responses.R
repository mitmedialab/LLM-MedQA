...
dat_info_3_L <- read.csv("/Users/shruthishekar/Desktop/Organized Experiment Data/Experiment 3.csv")
dat_info_3_L = dat_info_3_L[dat_info_3_L$Response.Source == "Satis - L", ] #Limit dataset to responses for this evaluation question type
