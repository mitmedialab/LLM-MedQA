...
dat_info_3_D <- read.csv("/Users/shruthishekar/Desktop/Organized Experiment Data/Experiment 3.csv")
dat_info_3_D = dat_info_3_D[dat_info_3_D$Response.Source == "Satis - D", ] #Limit dataset to responses for this evaluation question type
