...
dat_info_3_H <- read.csv("/Users/shruthishekar/Documents/GitHub/LLM-MedQA/3) Organized Experiment Data/Experiment 3.csv")
dat_info_3_H = dat_info_3_H[dat_info_3_H$Response.Source == "Info - H", ] #Limit dataset to responses for this evaluation question type
